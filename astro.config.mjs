  ...
  integrations: [
    ...
    sitemap({
      ...
      serialize(item) {
        ...
        else if (/\/journal\/(modelisation-3d|inauguration-industrielle-pipa|evenement-groupama|reunion-confidentielle|evenement-entre-lyon-geneve|pleniere-gala-evenement|lieux-seminaire-evenement|convention-ekinox|valexpo-oyonnax|business-center-dirigeants)/.test(url)) item.priority = 0.85;
