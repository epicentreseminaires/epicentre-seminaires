---
title: "Captation vidéo d'événement d'entreprise : le guide"
description: "Multicam, 4K, streaming, livrables : ce qu'il faut comprendre sur la captation vidéo de plénière, gala ou convention pour bien arbitrer."
...
1. **Diffusion live** (streaming) : vos collaborateurs distants suivent en direct la plénière depuis chez eux, vos sites distants, ou des salles relais.
2. **Archive corporate** : vous gardez une trace structurée de l'événement (discours du dirigeant, intervention experte, lancement officiel) pour la communication interne et les usages ultérieurs.
3. **Communication externe** : extraits vidéo pour vos réseaux sociaux, votre site, vos relations presse, votre communication client.
...
1. **Combien de caméras** et quelle résolution ?
2. **Qui réalise** en direct ? Quelle est son expérience ?
3. **Quel matériel précis** est utilisé (marques, modèles) ?
4. **Quels livrables** post-événement, sous quel délai ?
5. **Quel plan B** en cas de panne (caméra, connexion, son) ?
