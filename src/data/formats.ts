...
export const formats: FormatEntry[] = [
  ...
  // ============================================================
  {
    ...
    metaDescription: 'Plénière, conférence, congrès d\'entreprise dans la Plaine de l\'Ain, l\'Ain et Lyon : scène, son, lumière, vidéo, IMAG. Production complète.',
  ...
  },
  {
    ...
    metaDescription: 'Inauguration de site industriel ou de bâtiment dans la Plaine de l\'Ain et l\'Ain : discours, captation, presse, cocktail. Coordination ERP.',
